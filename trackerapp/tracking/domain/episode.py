...
from ..external.schemas.episodes_schemas import EpisodeSchema, EpisodeFullSchema
...
class Episode():
    ...
    def from_schema(cls, episode_schema : EpisodeSchema | EpisodeFullSchema):
        synopsis = episode_schema.synopsis if isinstance(episode_schema, EpisodeFullSchema) else None
        return Episode(
